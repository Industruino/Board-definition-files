...
/*
  Modified 28 June 2013 by Justin Mattair
     for MattairTech MT-DB-xx boards (www.mattairtech.com)
*/
...
void USBSerial::begin(long USBOptions)
{
	...
	if (USBOptions & USB_AUTOFLUSH_DISABLED) {
        ...
        if (USBOptions & USB_WAITFORCONNECT_ENABLED) {
                while (!Serial);
        }
}
