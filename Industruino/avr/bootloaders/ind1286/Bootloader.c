...
/*
  Modified 28 March 2013 by Justin Mattair
...
//3904
#define TIMEOUT2_PERIOD	3904
bool Timeout2Enabled = true;
uint16_t Timeout2 = 0;
...
int main(void)
{
	...
	*bootKeyPtr = 0;
	...
	/* Determine boot mode by reading HWB Jumper. Note that the hardware HWB function is not used.
...
#if defined(ENABLE_CLKDIV_1_APPLICATION)
